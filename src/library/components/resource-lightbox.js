...
var ResourceLightbox = Component({
  ...
  renderRequirements: function () {
    ...
    if (resource.sensors != undefined && resource.sensors.length > 0) {
      ...
      requirementsSensors = <p>This resource requires the use of {sensorTypes} {sensorTerm}. You will also need the Concord Consortium's SensorConnector software installed. Download the SensorConnector from <a href="https://sensorconnector.concord.org/" target="_blank">sensorconnector.concord.org</a>. For information on what types of sensors are supported, please see <a href="https://sensorconnector.concord.org/" target="_blank">sensorconnector.concord.org</a>.</p>
    }
    return (
