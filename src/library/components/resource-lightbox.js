...
var ResourceLightbox = Component({
  ...
  renderLicense: function () {
    ...
    var attributionName = 'The Concord Consortium'
    var attributionUrl = 'https://concord.org/'
    ...
    if (license.code !== 'CC0') {
      if (!resource.credits) {
        licenseAttribution = p({}, 'Suggested attribution: ' + resource.name + ' by ',
          a({href: attributionUrl}, attributionName),
          ' is licensed under ',
          a({href: license.deed}, license.code),
          '.'
        )
      } else {
        licenseAttribution = p({}, 'Suggested attribution: ' + resource.name + ' by ' + resource.credits,
          ' is licensed under ',
          a({href: license.deed}, license.code),
          '.'
        )
