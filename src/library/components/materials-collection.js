    ...
    return div({className: "stem-finder-materials-collection-item"},
      ...
      div({className: "stem-finder-materials-collection-item-info"},
        ...
        div({className: "stem-finder-materials-collection-item-footer"},
          div({className: "stem-finder-materials-collection-item-grade-levels"},
            "Grade Levels"
          ),
          div({className: "stem-finder-materials-collection-item-buttons"},
            button({className: "stem-finder-materials-collection-assign-button"}, "Assign Activity"),
            button({className: "stem-finder-materials-collection-launch-button"}, "Launch Activity")
          )
        )
      )
