...
var NgssHelper = function() {
    ...
    this.getDiv = function() {
        ...
        var peDiv           = null;
        var dciDiv          = null;
        var practicesDiv    = null;
        var conceptsDiv     = null;
        ...
        practicesDiv    = getGroupedDiv(this.practicesGroup, PRACTICES);
        conceptsDiv     = getGroupedDiv(this.conceptsGroup, CONCEPTS);
